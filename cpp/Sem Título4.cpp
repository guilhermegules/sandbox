		...
		case 1:
			...
			switch(opcao2){
				case 1:
					...
					FILE*cadastros;
					char cadast[50];
					pont_arq1 = fopen("transporte.txt", "a");
					if(cadastros == NULL){
						printf("ERROR");
						}	
					if(item==1){
						if(quant<4){
							fprintf(pont_arq1,"%i componentes transportados pelo usuario %s\nPeso total de: %.2f kg\n", quant, nome, resultado);
							printf("%i componentes transportados pelo usuario %s\nPeso total de: %.2f kg\n", quant, nome, resultado);
					...
					if(item==2){
						if(quant<4){
							fprintf(pont_arq1,"%i paineis transportados pelo usuario %s\nPeso total de: %.2f kg\n", quant, nome, resultado);
							printf("%i paineis transportados pelo usuario %s\nPeso total de: %.2f kg\n", quant, nome, resultado);
							printf("Transporte registrado com sucesso!\n");
							return 0;
							fclose(pont_arq1);
							}
					...
					if(item==3){
						if(quant<4){
							fprintf(pont_arq1,"%i cofres transportados pelo usuario %s\nPeso total de: %.2f kg\n", quant, nome, resultado);
							printf("%i cofres transportados pelo usuario %s\nPeso total de: %.2f kg\n", quant, nome, resultado);
							printf("Transporte registrado com sucesso!\n");
							return 0;
							fclose(pont_arq1);
							}
