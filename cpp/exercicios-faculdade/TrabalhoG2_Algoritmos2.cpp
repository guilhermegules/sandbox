...
int main(){
	...
	FILE *pont_arq1; // cria vari�vel ponteiro para o arquivo
	...
	const int TAM = 5;
	float peso = 0;
	float resultado; //Declara��o de variavel armazenando fun��o
			...
			switch(opcao2){
				case 1:
					...
					do{
						...
						printf("1-Componentes eletr�nicos\n2-Painel\n3-Cofre\n");
						scanf("%i", &item);
						if(item>3||item<=0){
							printf("Sele��o de itens incorreta! Digite novamente.\n");
						}
					}while(item>3||item<=0);
					...
					while(quant<=0){
						...
						scanf("%i", &quant);
						if(quant<=0){
							printf("Quantidade de produtos inv�lida! Digite novamente\n");
							}
						}
